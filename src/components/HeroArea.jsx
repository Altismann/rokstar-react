        ...
        >
            <div className="container">
                <div className="font-light">
                    ...
                    Sitecraft är en webbyrå som skapar hemsidor är skapade för att vara snabba och minimalistiska i sitt
                    utseende och för att stödja viktiga funktioner och sökoptimeringstekniker (SEO) Sidorna byggs
                    med Wordpress och NextJS och vi använder oss av nya och stabila hostinglösningar. Då vi endast gör sidor 
